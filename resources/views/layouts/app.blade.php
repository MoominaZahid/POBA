...
<body>
    ...
    <nav class="navbar">
        <div class="navbar-inner">
            ...
            {{-- Right Side Links --}}
            <ul class="navbar-nav nav-right" id="navRight">
            ...
            {{-- ✅ Hamburger OUTSIDE both nav lists so it always stays visible on mobile --}}
            <button class="navbar-hamburger" id="navToggle" onclick="toggleNav()" aria-label="Toggle navigation">
                <span></span>
                <span></span>
                <span></span>
            </button>
    ...
    <script>
        ...
        function toggleNav() {
            ...
            toggle.classList.toggle('open');    // animates ☰ → ✕
            navLeft.classList.toggle('open');   // shows left links
            navRight.classList.toggle('open');  // shows right links
        }

        // Close menu when a nav link is clicked (good UX on mobile)
        document.querySelectorAll('#navLeft a, #navRight a').forEach(function(link) {
            link.addEventListener('click', function() {
                // Only close if we're in mobile mode (hamburger visible)
